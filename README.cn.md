...
合计: **123,087** 行代码（覆盖前 5 种语言、共 **352** 个文件）。
...
- **上游仓库**: <https://github.com/psf/black>
...
- **Star**: 41,840 · **Fork**: 2,865 · **开放 issue**: 2,819 · **贡献者**: 552

## 累计统计

- **发布数**: 55 · **已合并 PR**: 1901 · **开放 PR**: 42 · **已关闭 issue**: 2551 · **开放 issue**: 268 · **提交数**: 2321

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-12 | 0 | 15 | 17 | 3 | 4 | 18 |
| last60d | 2026-07-13 | 0 | 52 | 31 | 11 | 6 | 51 |
| 90d | 2026-06-13 | 0 | 80 | 35 | 18 | 8 | 80 |
| last180d | 2026-03-15 | 2 | 151 | 38 | 30 | 10 | 150 |
| 360d | 2025-09-16 | 9 | 300 | 42 | 76 | 14 | 300 |
| last720d | 2024-09-21 | 11 | 408 | 42 | 179 | 20 | 410 |
...
在 [repology.org](https://repology.org/project/black) 上共有 **166** 个发行版报告此项目。**43** 个 ✅ 已是最新上游版本，**116** 个 ⚠️ 使用旧版本。
...
black 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `black` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/black.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T04:43:42Z._
